...
def setup_training_loop_kwargs(
    ...
    if cond: #TODO: change this to reflect captions not labels
        args.training_set_kwargs = dnnlib.EasyDict(class_name='training.dataset.TextDataset', path=data, use_labels=True, max_size=None, xflip=False)
    else:
